				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<!-- اذا المستخدم مدير يظهر زر الاشعارات  -->
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<a href="{{url('MarkAsRead_all')}}" class="badge badge-pill badge-warning mr-auto my-auto float-left">
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">تعيين قراءة لكل </span>

											</a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
										عدد الاشعارات الغير مقروئة
									...
									@foreach(auth()->user()->unreadNotifications as $notification)
										<a class="d-flex p-3 border-bottom" href="{{url('MarkAsRead_one')}}/{{$notification->data['id'] }}">
