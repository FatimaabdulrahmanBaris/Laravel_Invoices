...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبا بك في برنامج الفواتير</h2>
						  <p class="mg-b-0">تقارير , فواتير </p>
						</div>
					</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											{{number_format(\App\Models\invoices::where('status','غير مدفوعة')->count())}}
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											{{number_format(\App\Models\invoices::where('status','مدفوعة')->count())}}
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
										<h4 class="tx-20 font-weight-bold mb-1 text-white">
											{{number_format(\App\Models\invoices::where('status','مدفوعة جزئية')->sum('total'),2)}}


											</h4>
											<h4 class="tx-20 font-weight-bold mb-1 text-white">

											{{number_format(\App\Models\invoices::where('status','مدفوعة جزئية')->count())}}
...
<script src="{{URL::asset('assets/js/fatma.js')}}"></script>	
