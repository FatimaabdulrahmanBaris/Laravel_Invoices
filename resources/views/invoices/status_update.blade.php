                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <option value="{{$invoices->pro_section->id}}">
                                        {{$invoices->pro_section->section_name }}
                                    </option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea name="note" class="form-control" id="exampleTextarea"  rows="3"
                                value="{{$invoices->note}}"
                                ></textarea>
                            </div>
                        </div><br>
...
<script>
        $(document).ready(function() {
            $('select[name="Section"]').on('change', function() {
                ...
                if (SectionId) {
                    $.ajax({
                        url: "{{ URL::to('section_view') }}/" + SectionId,
                        type: "GET",
                        dataType: "json",
